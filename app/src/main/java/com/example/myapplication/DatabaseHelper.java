...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO "+ TABLE_BI +" (" + COLUMN_TITLE + ", " + COLUMN_AUTHOR + ", " + COLUMN_READER + ", " +COLUMN_PATH + ", " + COLUMN_DESC + ", " +COLUMN_TIME+ ", " +COLUMN_GENRE + ") " +
                   "VALUES ('1984', 'Орвелл', 'Вася Пупкин', '/storage/emulated/0/Android/data/com.example.myapplication/files/Music/680854__davejf__melody-loop.mp3', 'Для подавления массовых волнений Океании правящая партия заново воссоздает прошлое и настоящее. За каждым гражданином неусыпно наблюдают, каждому с помощью телевидения промывают мозги. И даже двое любовников вынуждены скрывать свои чувства, поскольку секс и межличностные отношения объявлены вне закона.', '600', 'социальная фантастика');");
        db.execSQL("INSERT INTO "+ TABLE_BI +" (" + COLUMN_TITLE + ", " + COLUMN_AUTHOR + ", " + COLUMN_READER + ", " +COLUMN_PATH + ", " + COLUMN_DESC + ", " +COLUMN_TIME+ ", " +COLUMN_GENRE + ") " +
                "VALUES ('1985', 'Орвелл', 'Вася Пупкин', '/storage/emulated/0/Android/data/com.example.myapplication/files/Music/680854__davejf__melody-loop.mp3', 'Для подавления массовых волнений Океании правящая партия заново воссоздает прошлое и настоящее. За каждым гражданином неусыпно наблюдают, каждому с помощью телевидения промывают мозги. И даже двое любовников вынуждены скрывать свои чувства, поскольку секс и межличностные отношения объявлены вне закона.', '600', 'социальная фантастика');");
        db.execSQL("INSERT INTO "+ TABLE_BI +" (" + COLUMN_TITLE + ", " + COLUMN_AUTHOR + ", " + COLUMN_READER + ", " +COLUMN_PATH + ", " + COLUMN_DESC + ", " +COLUMN_TIME+ ", " +COLUMN_GENRE + ") " +
